# -*- coding: utf-8 -*-
"""
Created on Wed Aug 12 20:38:46 2020
...
def updateMain(root):
    ...
    # Create dice buttons
    values = [3,4,5,6,7,8,10,12,14,16,20,24,30]
    labels = ["d3","d4","d5","d6","d7","d8","d10","d12","d14","d16","d20","d24","d30"]
    ...
    f0.grid(row=1,column=2,rowspan=len(values)+1,sticky="news")    
...
root = tk.Tk()
root.title("GORISORs Epic Dice Roller (DCC)")
